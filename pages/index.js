          ...
          <section>
            ...
            <Container>
              <Row>
                <div className="d-flex justify-content-center">
                  <p className="fuente">
                    Los palangres son líneas muy largas que tienen anzuelos
                    espaciados por una distancia de pocos pies. Pueden medir
                    muchas millas de largo.Los problemas con el palangre son más
                    frecuentes en pesquerías que operan cerca de la superficie
                    donde aves marinas, tiburones y tortugas quedan atrapados
                    por comer anzuelos cebados (con carnada).
                  </p>
                </div>
              </Row>
              <Row>
            ...
            <Container>
              <Row>
                <div className="d-flex justify-content-center">
                  <p className="fuente">
                    Una caña y línea de pescar captura peces de manera
                    individual. No hay problemas referentes a la captura
                    incidental.
                  </p>
                </div>
              </Row>
                ...
                <Row>
                  <div>
                    ...
                    <p className="fuente">
                      ...
                      el BIPMar Argentino, equipados para la exploración de
